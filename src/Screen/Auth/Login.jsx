...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        setErr(data.message || t('auth.login_failed'));
        return;
      }
